...
<style>
    /* =============== FORM SECTION - SAME AS SIGNIN PAGE =============== */
    .auth-wrapper {
        min-height: 100vh;
        background: #100028;
        display: flex;
    ...
    /* CAPTCHA Styling - adjusted to match signin style */
    .captcha-container {
        display: flex;
        align-items: center;
        gap: 15px;
    ...
    /* Password Strength Meter - adjusted to match signin style */
    .password-strength {
        margin-top: 8px;
        height: 8px;
        width: 100%;
    ...
    /* Role Select Styling - match signin style */
    #select {
    ...
    /* Form spacing - match signin */
    .mb-3 {
        margin-bottom: 20px !important;
    }

    /* Responsive - same as signin */
