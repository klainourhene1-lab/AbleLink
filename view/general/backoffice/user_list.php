...
<div style="display:flex; gap:15px; margin-bottom:20px;">
    ...
    <select id="roleFilter" 
            style="padding:10px; border-radius:10px; background:#1e293b; color:white;">
...
function applyFilters() {
    ...
    rows.forEach(row => {
        let roleText = row.children[3].innerText.toLowerCase();
        let statusText = row.children[4].innerText.toLowerCase();

        let show = true;

        if (role && role !== roleText) show = false;
