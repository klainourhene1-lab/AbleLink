    ...
    private function sendConfirmationEmailAsync($emailData) {
        ...
        register_shutdown_function(function() use ($emailData) {
            ...
            if (file_exists($templatePath)) {
                ...
                // Dynamic IP Detection Logic
                $serverHost = 'localhost'; // Safe fallback
                
                // Method 1: Check SERVER_ADDR (reliable if not behind proxy/load balancer)
                ...
                // Method 2: Scan network interfaces (often more reliable on local dev machines like XAMPP on Windows)
                else {
